...
(function() {
  ...
  const PROVERB_TITLES = [
    ...
    'Dig for It Like Silver',
    'Trust With Your Whole Chest',
    'Guard the Heart, It\'s the Wellspring',
    'Drink From Your Own Well',
    'Go Watch the Ant',
    'The Ox Didn\'t Know',
    'She Was There Before the Dirt',
    'Two Dinner Invitations',
    'The Mouth Is the Tell',
    'Honest Scales',
    'A Good Man Is Kind to His Donkey',
    'The Rod Is a Shepherd\'s Tool',
    'Awe Is a Fortress',
    'A Soft Answer',
    'The Lot Is in His Lap',
    'A Friend at All Times',
    'The Name Is a Tower',
    'Lend to God',
    'Who Can Find a Faithful Man?',
    'The Horse Is Ready, the Victory Is His',
    'A Good Name Over Great Riches',
    'Wings Like an Eagle',
    'Seven Times Down, Seven Times Up',
    'Coals on His Head',
